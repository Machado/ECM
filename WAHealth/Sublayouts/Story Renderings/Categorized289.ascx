<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Categorized289.ascx.cs" Inherits="WAHealth.ECM.Ignia.WAHealth.Sublayouts.Story_Renderings.Categorized289" %>
                                ...
                                <table align="Left" border="0" cellpadding="0" cellspacing="0" width="289" class="flexibleContainer">
                                    <tbody><tr>
                                        <td width="100%" valign="middle" class="subject">
                                            <sc:FieldRenderer runat="server" ID="CategoryField" FieldName="Newsletter Category"/> 
                                        </td>
                                    </tr>
                                    <tr>
