<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Story1200x600.ascx.cs" Inherits="WAHealth.ECM.Ignia.WAHealth.Sublayouts.Story_Renderings.Story1200x600" %>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" class="emailButton">
                                                <tbody><tr>
                                                    <td align="right" valign="middle" class="buttonContent">
                                                        <a href="<%#GetUrl(DataSource) %>" target="_blank"><sc:FieldRenderer runat="server" ID="ButtonTextField" FieldName="Newsletter Button Text"/></a>
                                                    </td>
                                                </tr>
                                            </tbody></table>
                                        </td>
