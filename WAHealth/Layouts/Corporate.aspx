<%@ Page Language="c#" CodePage="65001" AutoEventWireup="true" Inherits="WAHealth.ECM.Ignia.WAHealth.Layouts.Corporate" CodeBehind="Corporate.aspx.cs" %>
...
<head>
    ...
    <link href="/Ignia/WAHealth/Resources/CSS/Corporate-styles.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        /*////// TABLET STYLES //////*/
        ...
        <center>
            <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable">
                <tbody>
                    ...
                    <tr>
                        <td width="100%" align="center" valign="top" class="headerCorp" bgcolor="#005B38" id="header">
                    ...
                    <!-- FOOTER - 100% width colour band // -->
                    <tr>
                        <td width="100%" align="center" valign="top" class="headerFooterCell" bgcolor="#005b38">
                            <!-- CENTERING TABLE // -->
                                    ...
                                    <tr><td align="center">
                                        <table border="0" cellpadding="0" cellspacing="0" width="600" class="flexibleContainer">
                                            <tbody>
                                                <tr>
                                                    <td align="center" valign="top">
                                                        <table width="290" align="left" border="0" cellpadding="0" cellspacing="0" class="flexibleContainerSmall">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left" valign="top">
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="top">
                                                                                        <img src="/Ignia/WAHealth/Resources/Images/icon-address-white.png" height="13" width="17" alt="•" />
                                                        ...
                                                        <table width="120" align="right" border="0" cellpadding="0" cellspacing="0" class="flexibleContainerSmall">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="right">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="40" align="right" valign="middle">
                                                                                        <a href="https://twitter.com/wahealth">
                                                                                            <img src="/Ignia/WAHealth/Resources/Images/footer-social-icon-twitter-circle-green.png" alt="twitter" height="40" width="40" border="0" style="display: block; border: none; outline: none; text-decoration: none;" class="social-icon" /></a>
                                                                                    </td>
                                                                                    <td width="45" align="right" valign="middle">
                                                                                        <a href="http://www.youtube.com/user/wahealth">
                                                                                            <img src="/Ignia/WAHealth/Resources/Images/footer-social-icon-youtube-circle-green.png" alt="YouTube" height="40" width="40" border="0" style="display: block; border: none; outline: none; text-decoration: none;" class="social-icon" /></a>
                                                                                    </td>
                                                                                    <td width="45" align="right" valign="middle">
                                                                                        <a href="http://www.linkedin.com/company/health-department-western-australia/">
                                                                                            <img src="/Ignia/WAHealth/Resources/Images/footer-social-icon-linkedin-circle-green.png" alt="linked in" height="40" width="40" border="0" style="display: block; border: none; outline: none; text-decoration: none;" class="social-icon" /></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                    ...
                    <!-- // FOOTER - 100% width colour band -->
                    <!-- SECOND FOOTER - 100% colour band // -->
                    <tr>
                        <td width="100%" align="center" valign="top" class="headerFooterCell" bgcolor="#273138" id="footerCell">
													...
													<span>&nbsp;|&nbsp;</span>--%>
                                                            ...
                                                            <table width="120" align="right" border="0" cellpadding="0" cellspacing="0" class="flexibleContainerSmall">
                                                                <tbody>
                                                                    <tr>
                                                                        <td align="right" valign="middle">
                                                                            <span style="font-size: 10px; color: #e5e5e5">©&nbsp;Department of Health</span>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
